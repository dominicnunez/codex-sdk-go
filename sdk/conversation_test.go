...
func TestConversationMultiTurn(t *testing.T) {
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		...
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-1","text":"Hi there!"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-2","text":"4"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
...
func TestConversationTurnStreamed(t *testing.T) {
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-1","text":"Hi"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
...
func TestConversationTurnIgnoresStaleTurnNotifications(t *testing.T) {
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-1","text":"first"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-stale","item":{"type":"agentMessage","id":"item-stale","text":"stale"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-2","text":"fresh"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
...
func TestConversationFailedTurnIsRecordedAndDisablesMissingTurnIDFallback(t *testing.T) {
	proc, mock := mockProcess(t)
	...
	go func() {
		r, err := conv.Turn(ctx, codex.TurnOptions{Prompt: "first fails"})
		firstDone <- turnResult{result: r, err: err}
	}()
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-1","text":"partial"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
	...
	first := <-firstDone
	if first.err == nil {
		t.Fatal("expected error from failed first turn")
	}
	if first.result != nil {
		t.Fatal("expected nil result from failed first turn")
	}

	thread := conv.Thread()
	if len(thread.Turns) != 1 {
		t.Fatalf("len(Thread().Turns) = %d, want 1", len(thread.Turns))
	}
	...
	if thread.Turns[0].Error == nil || thread.Turns[0].Error.Message != "rate limited" {
		t.Fatalf("Thread().Turns[0].Error = %+v, want rate limited", thread.Turns[0].Error)
	}
	if len(thread.Turns[0].Items) != 1 {
		t.Fatalf("len(Thread().Turns[0].Items) = %d, want 1", len(thread.Turns[0].Items))
	}
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-2","text":"final"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
...
func TestConversationThreadDeepCopyRetainsItemsFromItemCompleted(t *testing.T) {
	...
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "item/completed",
		Params:  json.RawMessage(`{"completedAtMs":1,"threadId":"thread-1","turnId":"turn-1","item":{"type":"agentMessage","id":"item-1","text":"original"}}`),
	})
	mock.InjectServerNotification(ctx, codex.Notification{
		JSONRPC: "2.0",
		Method:  "turn/completed",
